      ...
      >
        <div className="flex items-start gap-2.5">
          ...
          <div className="min-w-0 flex-1">
            <p className="text-xs text-neutral-900 line-clamp-2 leading-relaxed">
              {entry.input}
            </p>
    ...
    >
      {showHistory && (
        <div className="flex h-screen max-h-screen flex-col overflow-hidden">
          <div className="flex-shrink-0 border-b border-neutral-100 px-4 py-5 pt-20">
            ...
            {history.length > 0 && (
              <div className="mt-3 relative">
                ...
                <input
                  ...
                  placeholder="Search..."
                  className="w-full pl-8 pr-7 py-1.5 text-xs border border-neutral-200 rounded-lg bg-neutral-50 focus:bg-white focus:border-neutral-300 transition-colors outline-none"
                />
                {searchQuery && (
                  <button
                    onClick={() => onSearchChange('')}
                    className="absolute right-2 top-1/2 transform -translate-y-1/2 p-0.5 hover:bg-neutral-100 rounded transition-colors"
