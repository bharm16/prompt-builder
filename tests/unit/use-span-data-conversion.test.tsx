...
vi.mock(
  "@features/prompt-optimizer/PromptCanvas/utils/spanDataConversion",
  () => ({
...
describe("useSpanDataConversion", () => {
  it("converts persisted highlights and forwards them to the selector", () => {
    ...
    expect(
      mockConvertHighlightSnapshotToSourceSelectionOptions,
    ).toHaveBeenCalledWith(initialHighlights);
    ...
    expect(result.current.convertedInitialHighlights).toEqual({
      spans: [],
      signature: "sig-1",
    });
