...
import {
  ...
  ContextFieldTag,
} from "@/components/ContextPreviewBadge";
...
describe("ContextPreviewBadge components", () => {
  ...
  describe("edge cases", () => {
    it("truncates long context field values and keeps full title", () => {
      ...
      expect((tag.textContent ?? "").length).toBeLessThan(
        "This is a very long context string that should be truncated".length,
      );
      expect(tag).toHaveAttribute(
        "title",
        "This is a very long context string that should be truncated",
      );
