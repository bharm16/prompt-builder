...
vi.mock(
  "@features/prompt-optimizer/PromptCanvas/utils/exportFormatConversion",
  () => ({
...
describe("usePromptExport", () => {
  ...
  it("exports prompt and closes menu on success", () => {
    ...
    expect(debug.logAction).toHaveBeenCalledWith("export", {
      format: "markdown",
      mode: "video",
    });
    expect(debug.startTimer).toHaveBeenCalledWith("export");
    expect(debug.endTimer).toHaveBeenCalledWith(
      "export",
      "Export as markdown successful",
    );
