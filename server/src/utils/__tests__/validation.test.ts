...
describe("validation re-exports", () => {
  it("re-exports schema definitions from config/schemas/index", () => {
    ...
    expect(validationExports.suggestionSchema).toBe(
      schemasMock.suggestionSchema,
    );
    expect(validationExports.videoValidationSchema).toBe(
      schemasMock.videoValidationSchema,
    );
    expect(validationExports.compatibilityOutputSchema).toBe(
      schemasMock.compatibilityOutputSchema,
    );
