  ...
  describe("getPrinciplesForDomain", () => {
    ...
    describe("core behavior", () => {
      it("returns domain-specific principles for creative-content", () => {
        const result =
          ConstitutionalAI.getPrinciplesForDomain("creative-content");
        expect(result.length).toBeGreaterThan(
          ConstitutionalAI.getDefaultPrinciples().length,
        );
      ...
      it("returns domain-specific principles for business-content", () => {
        const result =
          ConstitutionalAI.getPrinciplesForDomain("business-content");
  ...
  describe("applyConstitutionalReview", () => {
    describe("error handling", () => {
      it("throws when critique response is not valid JSON", async () => {
        ...
        await expect(
          ConstitutionalAI.applyConstitutionalReview(
            client,
            "prompt",
            "output",
          ),
    ...
    describe("core behavior", () => {
      ...
      it("calls complete exactly once when no revision needed", async () => {
        ...
        await ConstitutionalAI.applyConstitutionalReview(
          client,
          "prompt",
          "output",
        );
  ...
  describe("quickValidation", () => {
    describe("core behavior", () => {
      it("returns true when response is YES", async () => {
        expect(
          await ConstitutionalAI.quickValidation(
            makeMockClient(["YES"]),
            "output",
          ),
        ).toBe(true);
      ...
      it("reads from content array fallback", async () => {
        ...
        expect(await ConstitutionalAI.quickValidation(client, "output")).toBe(
          true,
        );
      });
    });
