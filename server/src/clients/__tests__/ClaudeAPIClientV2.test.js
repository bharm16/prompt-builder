...
import { ClaudeAPIClientV2, APIError, TimeoutError, ServiceUnavailableError } from '../ClaudeAPIClientV2.js';
...
describe('ClaudeAPIClientV2', () => {
  ...
  beforeEach(() => {
    ...
    client = new ClaudeAPIClientV2('test-api-key', {
  ...
  describe('Constructor and Initialization', () => {
    it('should initialize with default configuration', () => {
      const defaultClient = new ClaudeAPIClientV2('test-key');
    ...
    it('should initialize with custom configuration', () => {
      const customClient = new ClaudeAPIClientV2('custom-key', {
  ...
  describe('Error Handling', () => {
    ...
    it('should throw TimeoutError when request times out', async () => {
      ...
      const shortTimeoutClient = new ClaudeAPIClientV2('test-key', {
        timeout: 100,
      });
