  ...
  criteria: [
    {
      ...
      scale: "1-5",
      description:
        "Does the phrase use technical lexicon from the Director's Lexicon?",
      examples: {
    ...
    },
    {
      ...
      scale: "1-5",
      description:
        "Is the description concrete and camera-visible? No abstractions?",
      examples: {
    ...
    },
    {
      ...
      scale: "1-5",
      description:
        "Is it free from offensive, biased, or inappropriate content?",
      examples: {
