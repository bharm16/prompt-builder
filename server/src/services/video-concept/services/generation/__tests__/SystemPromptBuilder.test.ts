...
vi.mock('@services/video-concept/config/descriptorCategories', () => ({
  detectDescriptorCategory: vi.fn(() => ({ category: 'wardrobe', confidence: 0.9, taxonomyId: null })),
...
describe('PromptBuilderService', () => {
  ...
  it('builds descriptor prompt without category when no currentValue', async () => {
    ...
    detectDescriptorCategory.mockReturnValue({ category: null, confidence: 0, taxonomyId: null });
