...
import { SceneChangeDetectionService, type SceneChangeResult } from '../SceneChangeDetectionService';
...
describe('SceneChangeDetectionService', () => {
  ...
  it('detects scene change via LLM and caches result', async () => {
    ...
    vi.spyOn(StructuredOutputEnforcer, 'enforceJSON').mockResolvedValue(llmResult);
