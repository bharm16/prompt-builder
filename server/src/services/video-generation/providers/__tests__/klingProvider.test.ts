      ...
      .mockResolvedValueOnce(
        makeJsonResponse({
          ...
          data: {
            ...
            task_status: "succeed",
            task_result: {
              videos: [{ id: "video-1", url: "https://example.com/out.mp4" }],
            },
          },
        }),
      );
      ...
      .mockResolvedValueOnce(
        makeJsonResponse({
          ...
          data: {
            ...
            task_status: "succeed",
            task_result: {
              videos: [{ id: "video-2", url: "https://example.com/out-2.mp4" }],
            },
          },
        }),
      );
      ...
      .mockResolvedValueOnce(
        makeJsonResponse({
          ...
          data: {
            ...
            task_status: "succeed",
            task_result: {
              videos: [{ id: "video-3", url: "https://example.com/out-3.mp4" }],
            },
          },
        }),
      );
      ...
      .mockResolvedValueOnce(
        makeJsonResponse({
          ...
          data: {
            ...
            task_status: "succeed",
            task_result: {
              videos: [{ id: "v-ar", url: "https://example.com/ar.mp4" }],
            },
          },
        }),
      );
      ...
      .mockResolvedValueOnce(
        makeJsonResponse({
          ...
          data: {
            ...
            task_status: "succeed",
            task_result: {
              videos: [{ id: "v-169", url: "https://example.com/169.mp4" }],
            },
          },
        }),
      );
      ...
      .mockResolvedValueOnce(
        makeJsonResponse({
          ...
          data: {
            ...
            task_status: "succeed",
            task_result: {
              videos: [{ id: "v-none", url: "https://example.com/none.mp4" }],
            },
          },
        }),
      );
