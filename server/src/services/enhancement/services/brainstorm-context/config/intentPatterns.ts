...
export const CONFLICT_PATTERNS: ConflictPattern[] = [
  {
    ...
    suggestion:
      "Decide on a primary time period or intentionally blend as retrofuturism",
  },
  {
    ...
    suggestion:
      "Choose a primary mood or show contrast intentionally (e.g., calm before storm)",
  },
  {
    ...
    suggestion:
      'Reconcile with "dramatic chiaroscuro" or choose one primary lighting tone',
  },
  {
    ...
    suggestion:
      'Choose a primary visual approach or specify "stylized realism" as a hybrid',
  },
];
...
export const COMPLEMENTARY_RULES: ComplementRule[] = [
  {
    ...
    complements: [
      ...
      {
        element: "rim lighting on subject",
        reason: "Backlit subjects glow during golden hour",
      },
  ...
  },
  {
    ...
    complements: [
      {
        element: "caustic light patterns",
        reason: "Essential for underwater realism",
      },
      {
        element: "slow, fluid movement",
        reason: "Physics of water resistance",
      },
      {
        element: "blue-green color cast",
        reason: "Light absorption underwater",
      },
    ],
  },
  {
    ...
    complements: [
      {
        element: "high contrast ratio (4:1+)",
        reason: "Defines moody lighting technically",
      },
      {
        element: "selective pools of light",
        reason: "Creates dramatic shadows",
      },
      {
        element: "smoke or haze",
        reason: "Reveals light beams, adds atmosphere",
      },
    ],
  },
  {
    ...
    complements: [
      {
        element: "documentary-style framing",
        reason: "Matches handheld aesthetic",
      },
    ...
    intentSpecific: {
      "tension and suspense": [
        {
          element: "close-up framing",
          reason: "Handheld + close-ups heighten claustrophobia",
        },
      ],
    },
  },
  {
    ...
    complements: [
      ...
      {
        element: "shallow depth of field",
        reason: "Film aesthetic, subject isolation",
      },
      {
        element: "motivated lighting",
        reason: "Professional film lighting approach",
      },
    ],
  },
];
    ...
    checks: [
      ...
      },
      {
        ...
        suggestion: {
          ...
          reason:
            "Tension benefits from claustrophobic framing or unstable camera",
        },
      },
    ],
  },
