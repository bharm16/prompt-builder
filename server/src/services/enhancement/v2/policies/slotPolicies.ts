...
export const SLOT_POLICIES: SlotPolicy[] = [
  {
    ...
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'camera_focus', 'lighting_direction'],
    promptGuidance: 'Suggest only framing alternatives, not movement, lens, or focus details.',
    enumeratedOptions: [
  ...
  },
  {
    ...
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'camera_focus', 'shot_type'],
  ...
  },
  {
    ...
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'lighting_direction', 'lighting_source'],
    promptGuidance: 'Suggest only alternate times of day or daylight conditions.',
    enumeratedOptions: [
  ...
  },
  {
    ...
    forbiddenFamilies: ['technical_frame_rate', 'technical_resolution', 'technical_duration'],
  ...
  },
  {
    ...
    forbiddenFamilies: ['technical_aspect_ratio', 'technical_resolution', 'technical_duration'],
  ...
  },
  {
    ...
    forbiddenFamilies: ['technical_aspect_ratio', 'technical_frame_rate', 'technical_duration'],
  ...
  },
  {
    ...
    forbiddenFamilies: ['technical_aspect_ratio', 'technical_frame_rate', 'technical_resolution'],
  ...
  },
  {
    ...
    forbiddenFamilies: ['camera_lens', 'camera_focus', 'shot_type', 'lighting_direction'],
    promptGuidance: 'Compose a single camera move or support-style phrase.',
    rescueStrategy: { enabled: true, maxCalls: 1 },
    templated: {
      templates: [
        { name: 'movement-direction', orderedSlots: ['tempo', 'technique', 'direction'] },
        { name: 'movement-qualifier', orderedSlots: ['technique', 'supportQualifier'] },
        { name: 'static-frame', orderedSlots: ['technique', 'stabilityQualifier'] },
      ],
      slots: {
        tempo: ['slow', 'gentle', 'smooth'],
        technique: ['dolly', 'tracking', 'pan', 'tilt', 'crane', 'handheld', 'static'],
      ...
      optionalSlots: ['tempo', 'direction', 'supportQualifier', 'stabilityQualifier'],
      invalidCombinations: [
        { technique: ['static'], direction: ['forward', 'backward', 'lateral', 'upward', 'downward'] },
  ...
  },
  {
    ...
    promptGuidance: 'Compose a light-source phrase with natural lighting language.',
    rescueStrategy: { enabled: true, maxCalls: 1 },
    templated: {
      templates: [
      ...
      slots: {
        ...
        source: ['window light', 'sunlight', 'neon glow', 'candlelight', 'streetlamp spill'],
  ...
  },
  {
    ...
    promptGuidance: 'Compose a light-quality phrase, not a direction or camera phrase.',
    rescueStrategy: { enabled: true, maxCalls: 1 },
    templated: {
      templates: [
      ...
      slots: {
        quality: ['soft', 'hard', 'diffused', 'hazy', 'low-key', 'high-key', 'warm'],
  ...
  },
  {
    ...
    templated: {
      ...
      slots: {
        temperature: ['warm amber', 'cool cyan', 'neutral daylight', 'tungsten warmth', 'icy blue'],
      },
      invalidCombinations: [],
      renderRules: {
        joinWith: ' ',
  ...
  },
  {
    ...
    templated: {
      ...
      slots: {
        ...
        stock: ['Kodak Portra', 'Ektachrome', 'Fuji Velvia', 'Ilford HP5', 'digital cinema'],
      },
      invalidCombinations: [],
      renderRules: {
        joinWith: ' ',
  ...
  },
  {
    ...
    templated: {
      ...
      slots: {
        tone: ['desaturated', 'warm amber', 'cool steel-blue', 'muted pastel', 'high contrast'],
  ...
  },
  {
    ...
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'lighting_direction'],
    promptGuidance: 'Suggest literal, camera-visible subject alternatives that stay within the same scene role.',
    ...guidedLlmDefaults,
  },
  {
    ...
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'lighting_direction'],
    promptGuidance: 'Suggest literal subject identities, not camera or lighting details.',
    ...guidedLlmDefaults,
  },
  {
  ...
  },
  {
    ...
    requiredFamilies: ['action'],
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'lighting_direction'],
    promptGuidance: 'Suggest one continuous physical movement without repeating the trailing object.',
    ...guidedLlmDefaults,
  },
  {
  ...
  },
  {
    ...
    requiredFamilies: ['action'],
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'lighting_direction'],
    promptGuidance: 'Suggest a static pose or state that reads clearly on camera.',
    ...guidedLlmDefaults,
  },
  {
    ...
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'lighting_direction'],
    promptGuidance: 'Suggest location or environmental context details that stay literal and camera-visible.',
    ...guidedLlmDefaults,
  },
  {
    ...
    forbiddenFamilies: ['environment_context', 'camera_movement', 'camera_lens'],
    promptGuidance: 'Suggest external settings, not interior props or surfaces.',
    ...guidedLlmDefaults,
  },
  {
    ...
    forbiddenFamilies: ['environment_location', 'camera_movement', 'camera_lens'],
    promptGuidance: 'Suggest interior surfaces, atmosphere, or in-scene environmental context only.',
    ...guidedLlmDefaults,
  },
  {
    ...
    forbiddenFamilies: ['camera_movement', 'camera_lens', 'lighting_direction'],
    promptGuidance: 'Suggest literal weather descriptions that remain plausible for the scene.',
    ...guidedLlmDefaults,
  },
  {
    categoryId: 'style',
