...
export const toddlerCarBlockingBenchmarks: SuggestionBenchmarkFixture[] = [
  {
    ...
    testCase: {
      ...
      span: { text: "toddler's tiny rosy-cheeked face", category: 'subject.appearance' },
      ...
      nearbySpanHints: '- camera: "slowly zooming in"\n- subject: "plump hands"',
      expectedQualities: {
        contextualFit: { min: 5 },
    ...
    suggestions: [
      { text: 'wide-eyed face with dimpled cheeks', category: 'subject.appearance' },
      { text: 'bright eyes and flushed cheeks', category: 'subject.appearance' },
  ...
  },
  {
    ...
    testCase: {
      ...
      spanAnchors: '- action: "gripping"\n- subject: "dark grey steering wheel"',
      nearbySpanHints: '- subject: "toddler\'s tiny rosy-cheeked face"\n- action: "gripping"',
      expectedQualities: {
        contextualFit: { min: 5 },
        categoryAlignment: { min: 5 },
        diversity: { min: 5 },
    ...
    suggestions: [
      { text: 'soft little hands with bitten nails', category: 'subject.appearance' },
      { text: 'rounded palms with tiny birthmark', category: 'subject.appearance' },
      { text: 'small hands with sun-kissed knuckles', category: 'subject.appearance' },
    ],
  ...
  },
  {
    ...
    testCase: {
      ...
      spanAnchors: '- subject: "plump hands"\n- subject: "dark grey steering wheel"',
      nearbySpanHints: '- subject: "plump hands"\n- subject: "dark grey steering wheel"',
      expectedQualities: {
        contextualFit: { min: 5 },
        categoryAlignment: { min: 5 },
        diversity: { min: 5 },
  ...
  },
  {
    ...
    testCase: {
      ...
      nearbySpanHints: '- lighting: "golden hour sunlight"\n- environment: "car windows"',
      expectedQualities: {
        contextualFit: { min: 5 },
        categoryAlignment: { min: 5 },
        diversity: { min: 5 },
  ...
  },
  {
    ...
    testCase: {
      ...
      contextBefore: 'Warm, golden hour sunlight streams intensely through the ',
      contextAfter: ', creating high dynamic range lighting.',
      spanAnchors: '- lighting: "golden hour sunlight"\n- environment: "dashboard"',
  ...
  },
  {
    ...
    testCase: {
      ...
      spanAnchors: '- lighting: "soft, elongated shadows"\n- subject: "dark grey steering wheel"',
      nearbySpanHints: '- environment: "car windows"\n- lighting: "dust particles in the air"',
      expectedQualities: {
        contextualFit: { min: 5 },
        categoryAlignment: { min: 5 },
        diversity: { min: 5 },
  ...
  },
  {
    ...
    testCase: {
      ...
      nearbySpanHints: '- style: "Kodak Portra 400 film"\n- environment: "car\'s front window"',
      expectedQualities: {
        contextualFit: { min: 5 },
        categoryAlignment: { min: 5 },
        diversity: { min: 5 },
    ...
    invalidPatterns: ['dashboard', 'window glass', 'rearview mirror', 'console'],
  },
];
