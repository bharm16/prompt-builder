...
describe("NodeCacheAdapter", () => {
  ...
  describe("error handling", () => {
    ...
    it("handles cache set failure", async () => {
      ...
      expect(logger.warn).toHaveBeenCalledWith("Cache set failed", {
        key: "key",
      });
    });
  ...
  describe("core behavior", () => {
    ...
    it("deletes key from cache", async () => {
      ...
      expect(logger.debug).toHaveBeenCalledWith("Cache key deleted", {
        key: "key",
      });
    });
    ...
    it("generates key using key generator", () => {
      ...
      expect(keyGenerator.generate).toHaveBeenCalledWith("namespace", {
        prompt: "test",
      });
