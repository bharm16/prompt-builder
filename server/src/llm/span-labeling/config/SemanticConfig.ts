...
export const STYLE_REFERENCE_CONTEXT_REGEX =
  /\b(style reference|inspired by|reminiscent of|akin to|in the style of|inspired by the works of|inspired by the work of)\b/i;
