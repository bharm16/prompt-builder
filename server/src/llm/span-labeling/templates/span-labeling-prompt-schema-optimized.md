# Span Labeling System Prompt (Schema-Optimized)

Label video prompt elements using the taxonomy. Output structure is enforced by JSON schema - focus on WHAT to label, not HOW to format.
