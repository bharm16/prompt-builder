...
export function normalizeTargetModel(
  targetModel: PromptRequest["targetModel"],
): string | undefined {
...
export function normalizeContext(
  ...
  const backgroundLevel = BACKGROUND_LEVELS.has(
  ...
  return {
    ...
    backgroundLevel,
    intendedUse:
      typeof context.intendedUse === "string" ? context.intendedUse : "",
  };
}

export function normalizeLockedSpans(
  lockedSpans: PromptRequest["lockedSpans"],
): LockedSpan[] {
