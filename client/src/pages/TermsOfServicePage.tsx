      ...
      >
        <div className="mx-auto max-w-4xl flex items-center justify-between gap-4">
          <div className="min-w-0">
            ...
            <h1 className="text-[15px] font-semibold text-white tracking-tight">Terms of Service</h1>
          </div>
          ...
          <div className="p-4" style={CARD}>
            <div className="space-y-8 text-[12px] leading-relaxed" style={{ color: AUTH_COLORS.textSecondary }}>
              <section>
                ...
                <p>
                  These Terms govern your use of {productName} (the &ldquo;Service&rdquo;). By accessing or using the Service, you agree to these Terms.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  The Service is provided by {companyName} (&ldquo;we&rdquo;, &ldquo;us&rdquo;, &ldquo;our&rdquo;). Contact:{' '}
              ...
              <section>
                ...
                <p>
                  Don&apos;t misuse the Service. Don&apos;t reverse engineer, disrupt, or overload our systems, and don&apos;t use the Service to generate unlawful, harmful, or infringing content.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  Some features require payment. Subscriptions are charged on a recurring basis until you cancel (processed by Stripe).
                </p>
              ...
              <section>
                ...
                <p>
                  Our{' '}
                  <Link to="/privacy-policy" className="font-medium hover:underline" style={{ color: AUTH_COLORS.accent }}>
                    Privacy Policy
                  </Link>{' '}
              ...
              <section>
                ...
                <p>
                  You retain ownership of content you submit. You grant us a limited license to host, store, and process that content to operate and improve the Service.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  The Service is provided &ldquo;as is&rdquo; without warranties. AI outputs may be inaccurate; verify results before relying on them.
                </p>
              </section>
              ...
              <section>
                ...
                <p>
                  We may update these Terms. Material changes will be communicated. Continued use means you accept the updated Terms.
                </p>
              </section>
