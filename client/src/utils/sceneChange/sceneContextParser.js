 ...
 * @param {*} targetValue - The value to search for in the context
 * @returns {Object} Extracted context with changedField, affectedFields, etc.
 */
export function extractSceneContext(fullPrompt, targetValue) {
  if (!fullPrompt) {
    return {
