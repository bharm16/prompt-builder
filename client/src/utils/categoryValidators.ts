/**
 * DEPRECATED: This file has moved to features/span-highlighting/utils/categoryValidators.ts
 * 
...
if (import.meta.env.DEV) {
  console.warn(
    '[DEPRECATION] Importing from utils/categoryValidators.ts is deprecated. ' +
