...
const defaultHandlers = {
  onClose: vi.fn(),
  onCreate: vi.fn().mockResolvedValue({ id: '1', type: 'style', name: '', trigger: '', textDefinition: '' }),
  onUpdate: vi.fn().mockResolvedValue({ id: '1', type: 'style', name: '', trigger: '', textDefinition: '' }),
