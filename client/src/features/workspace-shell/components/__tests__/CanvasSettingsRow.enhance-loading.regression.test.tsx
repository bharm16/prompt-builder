...
vi.mock('@/features/prompt-optimizer/context/GenerationControlsContext', () => ({
  useGenerationControlsContext: () => ({
    controls: { isGenerating: false, onStoryboard: vi.fn(), onDraft: vi.fn(), onRender: vi.fn() },
  }),
}));
...
vi.mock('@/components/ToolSidebar/components/panels/GenerationControlsPanel/hooks/useCapabilitiesClamping', () => ({
...
vi.mock('@/components/ToolSidebar/components/panels/GenerationControlsPanel/hooks/useVideoInputCapabilities', () => ({
