...
import {
  ...
  type HighlightColor,
} from "../config/highlightStyles.ts";
...
export function createHighlightWrapper(
  ...
  el.dataset[DATASET_KEYS.VALIDATOR_PASS] =
    span.validatorPass === false ? "false" : "true";
 ...
 */
export function enhanceWrapperWithMetadata(
  wrapper: HTMLElement,
  span: SpanForWrapper,
): void {
  ...
  wrapper.dataset[DATASET_KEYS.DISPLAY_QUOTE] =
    span.displayQuote ?? span.quote ?? "";
