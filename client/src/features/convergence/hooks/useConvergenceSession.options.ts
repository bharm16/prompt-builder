...
const DEFAULT_OPTIONS_BY_DIMENSION: Record<DimensionType | 'direction', SelectionOption[]> = {
  ...
  camera_motion: [
    ...
    { id: 'dutch_left', label: 'Dutch Left' },
    { id: 'dutch_right', label: 'Dutch Right' },
    { id: 'push_in', label: 'Push In' },
    { id: 'pull_back', label: 'Pull Back' },
    { id: 'track_left', label: 'Track Left' },
    { id: 'track_right', label: 'Track Right' },
    ...
    { id: 'arc_left', label: 'Arc Left' },
    { id: 'arc_right', label: 'Arc Right' },
