...
export const ERROR_MESSAGES: Record<ConvergenceErrorCode, ErrorMessageConfig> =
  {
    SESSION_NOT_FOUND: {
      ...
      message:
        "We couldn't find your session. It may have been deleted or expired.",
      isRetryable: false,
    ...
    ACTIVE_SESSION_EXISTS: {
      ...
      isRetryable: false,
      suggestedAction:
        "Would you like to resume your existing session or start fresh?",
    },
    ...
    REGENERATION_LIMIT_EXCEEDED: {
      ...
      message:
        "You've reached the maximum number of regenerations (3) for this step.",
      isRetryable: false,
      suggestedAction:
        "Please select one of the current options or go back to try a different path.",
    },
    DEPTH_ESTIMATION_FAILED: {
      ...
      isRetryable: true,
      suggestedAction:
        "You can retry or use text-based camera motion selection instead.",
    },
    IMAGE_GENERATION_FAILED: {
      ...
      isRetryable: true,
      suggestedAction:
        "Please try again. If the problem persists, try a different prompt.",
    },
    VIDEO_GENERATION_FAILED: {
      ...
      isRetryable: true,
      suggestedAction:
        "You can retry or skip the preview and proceed to final generation.",
    },
    INCOMPLETE_SESSION: {
      ...
      isRetryable: false,
      suggestedAction:
        "Go back and make sure you've selected options for all steps.",
    },
    UNAUTHORIZED: {
