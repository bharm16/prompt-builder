...
describe("ShotVisualStrip", () => {
  ...
  it("uses thumbnail source priority and renders continuity connectors", async () => {
    ...
    expect(screen.getByAltText("Shot 1 thumbnail")).toHaveAttribute(
      "src",
      "https://img/scene-proxy-shot-1.png",
    );
    expect(screen.getByAltText("Shot 2 thumbnail")).toHaveAttribute(
      "src",
      "https://img/style-ref-2.png",
    );
    expect(screen.getByAltText("Shot 3 thumbnail")).toHaveAttribute(
      "src",
      "https://img/keyframe-3.png",
    );
    ...
    expect(
      screen.queryByTestId("shot-connector-shot-4"),
  ...
  it("renders generating and completed states", () => {
    ...
    expect(screen.getByTestId("shot-thumb-shot-1").className).toContain(
      "animate-pulse",
    );
