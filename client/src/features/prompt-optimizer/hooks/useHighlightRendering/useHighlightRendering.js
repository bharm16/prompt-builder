...
// Utils
import { processAndSortSpans } from './utils/spanProcessing.js';
import { validateHighlightText } from './utils/textMatching.js';
import {
...
import { hasOverlap, addToCoverage } from './utils/coverageTracking.js';

// Config
import { PERFORMANCE_MARKS, PERFORMANCE_MEASURES } from './config/constants.js';
