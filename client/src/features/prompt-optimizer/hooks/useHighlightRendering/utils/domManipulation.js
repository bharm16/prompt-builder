 ...
 */
export function enhanceWrapperWithMetadata(wrapper, span) {
 ...
 */
export function unwrapHighlight(element) {
 ...
 */
export function logEmptyWrappers(span, highlightStart, highlightEnd, nodeIndex, root) {
