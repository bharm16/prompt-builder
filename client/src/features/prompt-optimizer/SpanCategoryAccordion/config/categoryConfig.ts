 ...
 * Category metadata for the Span Category Accordion display
 *
 * Aligned with unified taxonomy system:
 * - Uses taxonomy parent categories as section keys
...
export const CATEGORY_CONFIG = {
  ...
  [TAXONOMY.SUBJECT.id]: {
    ...
    order: 2,
    description:
      "The focal point (person, object, animal) and their attributes",
  },
  [TAXONOMY.ACTION.id]: {
    label: "Action & Motion",
