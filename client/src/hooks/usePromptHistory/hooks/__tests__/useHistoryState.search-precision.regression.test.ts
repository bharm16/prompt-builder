  ...
  it("excludes entries where only the output contains the query", () => {
    const entries = [
      buildEntry(
        ...
        "Alternative angle of a dramatic car chase with cinematic lighting",
      ),
      buildEntry(
        "2",
        "An altar in a cathedral",
        "A stone altar bathed in golden light",
      ),
      buildEntry(
        "3",
        "Man staring out a window",
        "A melancholic scene with alternative color grading",
      ),
    ];
