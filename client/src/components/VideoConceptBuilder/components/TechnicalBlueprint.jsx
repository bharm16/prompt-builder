...
function renderTechnicalValue(value) {
...
function getTechnicalSections(technicalParams) {
...
export function TechnicalBlueprint({ technicalParams, isLoading }) {
  const technicalSections = getTechnicalSections(technicalParams);
  const hasTechnicalParams = technicalParams && Object.keys(technicalParams).length > 0;
