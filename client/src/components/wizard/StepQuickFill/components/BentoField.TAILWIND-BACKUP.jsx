...
export function BentoField({
  ...
  return (
    <div
      className={`bento-field bento-field--${bentoConfig.size} ${isExpanded ? 'bento-field--expanded' : ''} ${hasValue ? 'bento-field--filled' : ''}`}
      style={{
        opacity: mounted ? 1 : 0,
    ...
    >
      {!isExpanded ? (
        ...
        <div 
          ...
          style={{
            borderColor: bentoConfig.iconColor,
          ...
          <div className="bento-field__expanded-header">
            <div className="bento-field__expanded-title">
              ...
              <span className="bento-field__expanded-label">
                {field.label}
                {isRequired && (
                  <span style={{ color: bentoConfig.iconColor }}> *</span>
                )}
              </span>
            </div>
            <button
