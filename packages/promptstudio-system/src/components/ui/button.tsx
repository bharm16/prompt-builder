...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-ps-2 whitespace-nowrap rounded-lg text-button-14 font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50 ps-press [&_svg]:pointer-events-none [&_svg]:size-icon-sm [&_svg]:shrink-0",
  {
    variants: {
      variant: {
      ...
      size: {
        ...
        sm: "h-ps-7 px-ps-3 text-button-12",
        default: "h-ps-8 px-ps-4",
        md: "h-ps-8 px-ps-4",
        lg: "h-ps-9 px-ps-6 text-button-16",
        xl: "h-ps-10 px-ps-7 text-button-16",
        icon: "h-ps-8 w-ps-8 px-0",
        "icon-xs": "h-ps-6 w-ps-6 px-0 [&_svg]:size-icon-xs",
        "icon-sm": "h-ps-7 w-ps-7 px-0",
        "icon-lg": "h-ps-9 w-ps-9 px-0 [&_svg]:size-icon-md",
      },
    },
    defaultVariants: {
      variant: "default",
